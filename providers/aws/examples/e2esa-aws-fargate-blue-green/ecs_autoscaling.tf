...
# -----------------------------------------------
# AWS Scale Up Alarm
# Alarm will trigger the ASG policy (scale up) based on the metric (CPUUtilization), comparison_operator, threshold
# -----------------------------------------------
...
resource "aws_appautoscaling_target" "scale_target" {
  ...
  min_capacity       = var.scale_target_min_capasity
  max_capacity       = var.scale_target_max_capasity
  depends_on = [
    module.ecs-service-app
  ]
}
