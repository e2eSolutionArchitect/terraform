...
resource "aws_codedeploy_app" "this" {
  compute_platform = "ECS" # "ECS" or "Lambda"
...
resource "aws_codedeploy_deployment_group" "this" {
  ...
  deployment_config_name = var.deployment_config_name #"CodeDeployDefault.ECSAllAtOnce" or "CodeDeployDefault.LambdaAllAtOnce"
